...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<h1>Reducir Stock Articulo</h1>
		<form:form action="reducir-stock" method="POST" modelAttribute="modificarExistencias" path="modificarExistencias">
			...
			<form:input id="unidades" path="unidades" />
